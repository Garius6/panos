...
**Порядок, если делать**: Печатаемое/Арифметика/По-умолчанию — можно
брать сразу после Стадии 22 (тот же механизм, инкрементально). Клонируемое
— сначала обсуждение семантики. Хешируемое/Итерируемое — заводить
СВОИ стадии с полноценным Explore-investigation, не довесок к 22/23.

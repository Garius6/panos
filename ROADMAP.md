...
Стадия 23-Арифметика ✅, 23-Печатаемое ✅ закрыты. По-умолчанию
выброшена из плана (мотивация была спекулятивной, реального consumer'а
не нашлось — см. §3). Остаток Стадии 23 (Копируемое/Хешируемое/
Итерируемое) — список кандидатов, требует investigation до плана;
следующая по grilled-порядку — Копируемое.

...
dump fallback) ✅, 27 (`конст` — неизменяемые биндинги) ✅.
...
Стадия 23-Арифметика ✅, 23-Печатаемое ✅ закрыты. Остаток Стадии 23
...
binding-immutability, НЕ deep immutability) ✅ закрыта.
**Приоритет (grilled)**: 23/24/25/26/4/8 — следующие кандидаты, не
параллельно.

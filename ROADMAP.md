...
Стадия 23-Арифметика ✅ закрыта. Остаток Стадии 23 (Печатаемое/
По-умолчанию/Копируемое/Хешируемое/Итерируемое) — список кандидатов,
требует investigation до плана; следующая по grilled-порядку —
Печатаемое.

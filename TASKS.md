...
возможны). 23 (Печатаемое ✅/Арифметика ✅/Копируемое ✅/Итерируемое ✅/
Хешируемое; По-умолчанию выброшена — см. ниже) — Хешируемое остаётся
единственным кандидатом, требует investigation до плана. 28 (generic-
интерфейсы) ✅. 24 (lightweight

...
pub fn nativeModuleExports(name: []const u8) ?[]const []const u8 {
    const table = [_]struct { name: []const u8, exports: []const []const u8 }{
        ...
        .{ .name = "DOM", .exports = &.{ "текст", "установить_текст", "на_клик", "данные_клика", "атрибут_клика", "СобытиеКлика", "текст_строка", "установить_текст_строка", "значение_поля", "установить_значение_поля", "создать_и_добавить", "переместить", "после_кадра", "через_мс", "атрибут", "установить_атрибут", "удалить_атрибут", "удалить", "путь", "перейти" } },
        ...
        .{ .name = "криптография", .exports = &.{ "hmac_sha256_base64url", "base64url_кодировать", "base64url_декодировать", "сравнить_константное_время", "sha256_base64url", "pbkdf2_sha256_base64url", "случайные_байты_base64url", "es256_сгенерировать_ключи", "es256_подписать", "es256_проверить", "totp_секрет", "totp_код" } },
    };
    for (table) |entry| {
...
const Resolver = struct {
    ...
    fn installBuiltins(self: *Resolver, skip_prelude_hardcode: bool) !void {
        ...
        try self.installBuiltinModule("DOM", &.{ "текст", "установить_текст", "на_клик", "данные_клика", "атрибут_клика", "текст_строка", "установить_текст_строка", "значение_поля", "установить_значение_поля", "создать_и_добавить", "переместить", "после_кадра", "через_мс", "атрибут", "установить_атрибут", "удалить_атрибут", "удалить", "путь", "перейти" });
        ...
        try self.installBuiltinModule("криптография", &.{ "hmac_sha256_base64url", "base64url_кодировать", "base64url_декодировать", "сравнить_константное_время", "sha256_base64url", "pbkdf2_sha256_base64url", "случайные_байты_base64url", "es256_сгенерировать_ключи", "es256_подписать", "es256_проверить", "totp_секрет", "totp_код" });
    ...
    fn resolveStatement(self: *Resolver, statement: ast.StmtId) anyerror!void {
        ...
        switch (value) {
            ...
            .defer_stmt => |defer_stmt| try self.resolveExpression(self.tree, defer_stmt.value),

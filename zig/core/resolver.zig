...
pub fn nativeModuleExports(name: []const u8) ?[]const []const u8 {
    const table = [_]struct { name: []const u8, exports: []const []const u8 }{
        ...
        .{ .name = "DOM", .exports = &.{ "текст", "установить_текст", "на_клик", "данные_клика", "атрибут_клика", "СобытиеКлика", "текст_строка", "установить_текст_строка", "значение_поля", "установить_значение_поля", "создать_и_добавить", "переместить", "после_кадра", "атрибут", "установить_атрибут", "удалить_атрибут", "удалить", "путь", "перейти" } },
...
const Resolver = struct {
    ...
    fn installBuiltins(self: *Resolver, skip_prelude_hardcode: bool) !void {
        ...
        try self.installBuiltinModule("DOM", &.{ "текст", "установить_текст", "на_клик", "данные_клика", "атрибут_клика", "текст_строка", "установить_текст_строка", "значение_поля", "установить_значение_поля", "создать_и_добавить", "переместить", "после_кадра", "атрибут", "установить_атрибут", "удалить_атрибут", "удалить", "путь", "перейти" });
